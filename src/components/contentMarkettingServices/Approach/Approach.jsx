...
const Approach = () => {
  return (
    <ApproachContainer>
      ...
      <h3>
        Our perspective is backed by client experience, 
      ...
      <ApproachCards>
        <Cards>
            ...
            <Card>
                ...
                <p>We’ll take a look at the content marketing 
                    strategy that you currently have in place 
                    and we’ll compare it with what we know is 
                    successful.
                </p>
            </Card>
            ...
            <Card>
                ...
                <p>There’s nothing wrong with taking a look at
                    your main competitors and delving into
        ...
        <ApproachCenter>
            ...
            <Card>
                ...
                <p>In order to know who we are creating 
                    content to attract, we need to know what
                    makes them tick.
                </p>
            </Card>
        ...
        <Cards Gap>
            <Card>
                <h2>Analyze</h2>
                <p>Applying marketing principles and industry 
                    insights with your custom measurement 
                    plan ensures you have the data you need to
                    drive your business decisions.
                </p>
            </Card>
            <Card>
                <h2>Optimize</h2>
                <p>With a test + learn approach, we couple real 
                    data with best practices to maximize 
                    performance through continual refinement.
                </p>
            </Card>
        </Cards>
      </ApproachCards>
