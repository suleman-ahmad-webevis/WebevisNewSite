  ...
  return (
    <SuccessContainer>
      ...
      <SuccessCards>
        ...
        <Card>
            <h2>Better <br />Search <br/> Rankings</h2>
        </Card>
        </Cards>
        <Cards>
        <Image src={SuccessTraffic} alt='SuccessTraffic' />
        <Card>
            <h2>Increased <br />Website <br/> Traffic</h2> 
        </Card>
        </Cards>
        <Cards>
        <Image src={SuccessHighTraffic} alt='SuccessHighTraffic' />
        <Card>
            <h2>High <br />Organic <br/> Traffic</h2> 
        </Card>
        </Cards>
        <Cards>
        <Image src={SuccessBrand} alt='SuccessBrand' />
        <Card>
            <h2>Increased <br />Brand <br/> Awareness</h2>
        </Card>
        </Cards>
        <Cards>
