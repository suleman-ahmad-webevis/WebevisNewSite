...
import { CrucialButton, CrucialButtonDiff, CrucialCard, CrucialContainer, CrucialOptions } from './WhyCrucialStyles'
    ...
    <CrucialContainer>
      ...
      <CrucialOptions>
        ...
        <CrucialCard>
            ...
            your competitors’ strengths and weaknesses in comparison<br />
            to your own so that you can find an opportunity in the<br />
            market.
            </h5>
        ...
        <CrucialCard>
            ...
            <h5>
            With big changes in the ability to target and retarget prospective <br />
            ...
            understand their competitors, create better messaging, and find<br />
