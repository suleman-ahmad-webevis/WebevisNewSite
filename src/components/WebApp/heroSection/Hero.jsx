  ...
  return (
    <Container>
      <HeroSec>
        <HeroText>
          <h1>
            <span className="Text-gradient"> Web Application</span> <br />
          ...
          <p>
            ...
            Customers get killer software <br /> products that maximize the
            value of their offerings <br /> and increase the profitability of
            their business.
          </p>
          <PrimaryButton
            size="24"
